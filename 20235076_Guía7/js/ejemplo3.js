...
const startDOM = () => {
    ...
    // Obteniendo las referencias de botones para aumentar y disminuir tamaño de fuente
    const buttonAumentar = document.getElementById("idAumentar");
    const buttonDisminuir = document.getElementById("idDisminuir");
